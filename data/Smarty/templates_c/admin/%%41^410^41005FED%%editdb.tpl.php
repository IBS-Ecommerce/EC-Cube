<?php /* Smarty version 2.6.26, created on 2016-07-16 15:32:17
         compiled from system/editdb.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'system/editdb.tpl', 26, false),array('function', 't', 'system/editdb.tpl', 29, false),)), $this); ?>
...
" />
    ...
    <div class="btn">
        <a class="btn-action" href="javascript:;" onclick="fnFormModeSubmit('index_form', 'confirm', '', '');"><span class="btn-next"><?php echo smarty_function_t(array('string' => 'tpl_Change_02'), $this);?>
</span></a>
    </div>
    <table class="list">
        <col width="5%" />
        ...
        <col width="40%" />
        <tr>
            <th colspan="2"><?php echo smarty_function_t(array('string' => 'tpl_Index_01'), $this);?>
</th>
            <th rowspan="2"><?php echo smarty_function_t(array('string' => 'tpl_Table name_01'), $this);?>
</th>
            <th rowspan="2"><?php echo smarty_function_t(array('string' => 'tpl_Column name_01'), $this);?>
</th>
            <th rowspan="2"><?php echo smarty_function_t(array('string' => 'tpl_Explanation_01'), $this);?>
</th>
        </tr>
        <tr>
            <th><?php echo smarty_function_t(array('string' => 'tpl_ON_01'), $this);?>
</th>
            <th><?php echo smarty_function_t(array('string' => 'tpl_OFF_01'), $this);?>
</th>
        </tr>
...
" />
    ...
    <a class="btn-action" href="javascript:;" onclick="fnFormModeSubmit('index_form', 'confirm', '', ''); return false;"><span class="btn-next"><?php echo smarty_function_t(array('string' => 'tpl_Change_02'), $this);?>
</span></a>
</form>